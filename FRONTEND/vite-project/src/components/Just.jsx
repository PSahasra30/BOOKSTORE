  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        ...
        const response = await fetch("http://localhost:3000/api/books"); // Adjust URL to your API
            ...
            {filteredBooks.map((book) => (
              ...
              >
                <div>
                  ...
                  <img
                    src={`http://localhost:3000/uploads/${book.image}`} // Update this to your backend's URL structure
                    alt={book.title}
                    style={{
                      width: "100%",
                      height: "200px",
